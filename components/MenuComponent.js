...
const MenuComponent = ({ food }) => {
  ...
  return (
    <View>
      <Pressable style={styles.rootCont}>
        <View>
        ...
        <Pressable style={{ marginRight: 10 }}>
          <Image style={styles.imageStyle} source={{ uri: food.image }} />
          {selected ? (
            <Pressable style={styles.selectedAddButton}>
              <Pressable
                onPress={() => {
                  if (additems === 1) {
              ...
              >
                <Text style={styles.selectedAddText}>-</Text>
              </Pressable>

              <Pressable>
                <Text style={styles.selectedAddText}>{additems}</Text>
              </Pressable>
